...
const AboutSection = () => {
  ...
  return (
    <section className="text-negro  mt-[-250px] sm:mb-[110px] mb-[-170px] fuente " id="about">
      <div className="relative top-[750px] left-[600px] degradado h-[100px] w-[100px] order-[1px]  degradado rounded-tl-[50px] rounded-tr-[20px] rounded-bl-[29px] rounded-br-[45px] ">

      </div>
      <div className="relative bottom-[-300px] right-[-1100px] degradado h-[100px] w-[100px] order-[1px]  degradado rounded-tl-[50.5px] rounded-tr-[20px] rounded-bl-[29px] rounded-br-[50px] ">

      </div>
      <div className="relative top-[190px] left-[-50px] degradado h-[100px] w-[100px] order-[1px]  degradado rounded-tl-[20px] rounded-tr-[50.5px] rounded-bl-[50.5px] rounded-br-[29px] ">
      ...
      <div className="md:grid md:grid-cols-2 gap-8 sm:items-center  px-4 xl:gap-16   xl:px-16 bg-purpura rounded-[20px]">
        <div className=" rounded-tl-[20px] rounded-tr-[80px] rounded-bl-[80px] rounded-br-[20px] lg:w-[496px] lg:h-[300px] h-[100px]; degradado my-10" />
